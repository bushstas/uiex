 ...
 * @prop {boolean} [optional] None of tabs can be selected if it is true (multiple is always optional).
 * @prop {boolean} [dynamic] Has "add" tab button, closable tabs.
 * @prop {boolean} [noRemoving] You cant't remove any tab of dynamic tabs if is true.
